...
school_lunch_costs = int(input("How much school lunch costs? "))
school_lunch_times = int(input("How many times do you eat at camput in one month? "))
living_costs = int(input("How much rest of living costs is in one month? "))
